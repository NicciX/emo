...
local strings = {
	...
	["Good King Moggle Mog XII is now playing."] = "yoldance",
	["Fun and Games is now playing."] = {
		["routine"] = "funANDgames",
	},
...
local matchsticks = {
	["strikes"] = {
		...
		["ono"] = "*destination*",
		["onokoro"] = "*destination*",
		["tamimizu"] = "*destination*",
		["tamamizu"] = "*destination*",
		["tiramisu"] = "*destination*",
		["slitherin"] = "*destination*",
		["slitherbough"] = "*destination*",
		["slither"] = "*destination*",
		["viera"] = "*destination*",
		["qitari"] = "*destination*",
		["fanow"] = "*destination*",
		...
		["mnemo"] = "*destination*",
		["aleport"] = "*destination*",
		["wineport"] = "*destination*",
		["summerford"] = "*destination*",
		["apartment"] = "*destination*",
		["apt"] = "*destination*",
		["ananta"] = "*destination*",
		["gyr"] = "*destination*",
		["peering"] = "*destination*",
		["snake girls"] = "*destination*",
		["drybone"] = "*destination*",
